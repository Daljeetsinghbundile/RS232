...
static const char blankString[]= QT_TRANSLATE_NOOP("newDialog","N/A");
    ...
    m_intValidator(new QIntValidator(0,4000000,this))
{
    ...
    connect(m_ui->applyButton,&QPushButton::clicked,
            this,&newDialog::apply);                     
    connect(m_ui->serialPortInfoListBox,QOverload<int>::of(&QComboBox::currentIndexChanged),
            this,&newDialog::showPortInfo);
    connect(m_ui->baudRateBox,QOverload<int>::of(&QComboBox::currentIndexChanged),
            this,&newDialog::checkCustomBaudratePolicy);
    connect(m_ui->serialPortInfoListBox,QOverload<int>::of(&QComboBox::currentIndexChanged),
            this,&newDialog::checkCustomDevicePathPolicy);




    //connect(m_ui->applyButton,&QPushButton::clicked,this,&MainWindow::setObject());
...
newDialog::Settings newDialog::settings() const
{
    return m_currentSettings;

}

void newDialog::showPortInfo(int idx)
{
    if(idx==-1)
        return;
...
void newDialog::apply()
{
    updateSettings();
    hide();
}

void newDialog::checkCustomBaudratePolicy(int idx)
{
...
void newDialog::checkCustomDevicePathPolicy(int idx)
{
...
void newDialog::fillPortsParameters()
{
...
#endif
    m_ui->stopBitsBox->addItem(tr("2"), QSerialPort::TwoStop);
...
void newDialog::updateSettings()
{
    m_currentSettings.name = m_ui->serialPortInfoListBox->currentText();

qDebug()<<"m_currentSettings of port"<<m_currentSettings.name;
    ...
    m_currentSettings.stringsStopBits = m_ui->stopBitsBox->currentText();
